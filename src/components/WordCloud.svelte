...
{#key dynamics}
	<WordCloud words={words_freq_dict} width='500' font='Nunito' on:mouseover={resetRotation} minRotate={rotate} maxRotate={0-rotate} scheme='schemeSet2' backgroundColor='#f8f7f6'/>
{/key}
